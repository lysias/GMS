...
class ForumThread extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, name, forum_category_id', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'forumPosts' => array(self::HAS_MANY, 'ForumPost', 'forum_thread_id'),
			'forumCategory' => array(self::BELONGS_TO, 'ForumCategory', 'forum_category_id'),
		);
	}
